...
import {
  ...
  SelectItem,
  SelectTrigger,
  SelectValue,import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { Wallet, Bell, ArrowRight, Sparkles } from "lucide-react";
import { useAuth } from "@/hooks/useAuth";
import { supabase } from "@/integrations/supabase/client";
...
const Onboarding = () => {
  ...
  const finish = async (notif: boolean) => {
    ...
    try {
      ...
      // PERBAIKAN 1: Gunakan UPSERT untuk Profiles agar tidak error Unique Constraint
      const { error: pErr } = await supabase
        .from("profiles")
        .upsert({
          id: user.id, // Pastikan ID dikirim untuk update/insert
          username,
      ...
      const now = new Date();
      // PERBAIKAN 2: Gunakan upsert dengan filter yang lebih bersih
  ...
  return (
    // PERBAIKAN 3: Menambahkan container pembatas agar tidak lebar (max-w-md dan mx-auto)
      ...
      <div className="w-full max-w-md flex flex-col space-y-8">
        ...
        <div className="flex flex-col flex-1">
          {step === 1 && (
            <div className="space-y-8">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="w-full mt-10 space-y-2 text-left">
          ...
          {step === 4 && (
            <div className="space-y-8">
              <div className="flex flex-col items-center text-center">
                <div className="h-24 w-24 rounded-3xl bg-orange-100 text-orange-600 flex items-center justify-center mb-6">
