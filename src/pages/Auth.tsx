...
const handleGoogle = async () => {
  ...
  type="button" 
  variant="outline" 
  // Perhatikan class di bawah: text-black ditambahkan untuk memperjelas tulisan
  className="w-full h-11 border-white/20 bg-white text-black hover:bg-gray-100 transition-colors" 
